...
namespace FontSettings.Framework.Menus
{
    internal class FontSettingsPage : BaseMenu<FontSettingsMenuModel>
    {
        ...
        {
            int arrowWidth = 12 * Game1.pixelZoom;
            int arrowGap = 48;
            context.SetBounds(this.width + (arrowWidth + arrowGap) * 2, this.height, this.xPositionOnScreen, this.yPositionOnScreen);

            Grid grid = new Grid();
            grid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(arrowWidth + arrowGap) });
            grid.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.FillRemaningSpace });
            grid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(arrowGap + arrowWidth) });
            ...
            this._button_prevFontType.HorizontalAlignment = HorizontalAlignment.Left;
            this._button_prevFontType.VerticalAlignment = VerticalAlignment.Center;
            this._button_prevFontType.Click += (_, _) => Game1.playSound("smallSelect");
            grid.Children.Add(this._button_prevFontType);
            grid.SetColumn(this._button_prevFontType, 0);
            ...
            this._button_nextFontType.HorizontalAlignment = HorizontalAlignment.Right;
            this._button_nextFontType.VerticalAlignment = VerticalAlignment.Center;
            this._button_nextFontType.Click += (_, _) => Game1.playSound("smallSelect");
            grid.Children.Add(this._button_nextFontType);
            grid.SetColumn(this._button_nextFontType, 2);

            Grid mainGrid = new Grid();
            mainGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(64) });
            mainGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1, GridUnit.Percent) });
            mainGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(borderWidth / 2 + 48 + borderWidth / 2) });
            mainGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1, GridUnit.Percent) });
            ...
            grid.SetColumn(mainGrid, 1);
            {
                ...
                this._label_title.HorizontalAlignment = HorizontalAlignment.Center;
                this._label_title.VerticalAlignment = VerticalAlignment.Center;
                mainGrid.Children.Add(this._label_title);
                mainGrid.SetRow(this._label_title, 0);
                ...
                this._exampleBoard.HorizontalAlignment = HorizontalAlignment.Stretch;
                this._exampleBoard.VerticalAlignment = VerticalAlignment.Stretch;
                this._exampleBoard.Margin = new Thickness(spaceToClearSideBorder + borderWidth, 0);
                ...
                mainGrid.Children.Add(this._exampleBoard);
                mainGrid.SetRow(this._exampleBoard, 1);

                Grid previewGrid = new Grid();
                mainGrid.Children.Add(this._label_title);
                mainGrid.SetRow(previewGrid, 1);
                ...
                previewGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
                {
                    StackPanel previewOptionsStack = new StackPanel();
                    previewOptionsStack.Orientation = Orientation.Vertical;
                    previewGrid.Children.Add(previewOptionsStack);
                    previewGrid.SetColumn(previewOptionsStack, 0);
                    {
                        var mergeCheckbox = new LabeledElement<Checkbox>()
                    }
                }
