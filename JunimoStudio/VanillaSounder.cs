...
//        public void Play()
//        {
//            foreach (ICue cue in this._toPlayList.Values)
//            {
//                if (!cue.IsPlaying)
//                    cue.Play();
//            }
...
//            if (this.TryFindCue(key, out ICue cue))
//            {
...
//            if (this._audios.All(a => a is BasicXnaAudioObject))
//            {
//                audioName = subs[0];
//                cueName = subs[1];
//            }
...
//            if (this.TryFindAudioObject(audioName, out XnaAudioObject audioObj))
...
//        {
//            foreach (XnaAudioObject audioObj in this._audios)
